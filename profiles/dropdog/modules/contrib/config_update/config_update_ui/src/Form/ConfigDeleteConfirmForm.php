...
/**
 * @file
 * Contains \Drupal\config_update_ui\Form\ConfigDeleteConfirmForm.
 */
...
class ConfigDeleteConfirmForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    ...
    return $this->t('Are you sure you want to delete the %type config %item?', array('%type' => $type_label, '%item' => $this->name ));
  }
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!$value) {
      $form_state->setErrorByName('', $this->t('There is no configuration @type named @name to delete', array('@type' => $this->type, '@name' => $this->name)));
      return;
    }
  }
